...
USE HDF5
      ...
      integer A,I,J,K,IL,B,x,y,z,xmin,xmax,ymin,ymax,zmin,zmax
      ...
      allocate(dset_float(nx,ny,nz))
       ...
       call h5dread_f(dset_id,type_id,dset_float,dims,error)
        ...
        print *,'Input file:  ',INFILE
          ...
          print *,XMIN,XMAX,YMIN,YMAX,ZMIN,ZMAX,NUMVOX,AVG/dble(NUMVOX)
          write (10,*) '#XMIN,XMAX,YMIN,YMAX,ZMIN,ZMAX,NUMVOX'
          write (10,*) XMIN,XMAX,YMIN,YMAX,ZMIN,ZMAX,NUMVOX
          write (10,*) AVG/dble(NUMVOX)
      close(10)
