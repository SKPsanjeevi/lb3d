...
/* There seems something to be strang here: The dimensions are switched!!!! Jens, 18.7.06 */
	     fprintf(f2,"# vtk DataFile Version 2.0\nGenerated by xdr2vtk\nBINARY\n");
  	     fprintf(f2,"DATASET STRUCTURED_POINTS\n");
	     fprintf(f2,"DIMENSIONS %d %d %d\n",nz,ny,nx);
	     fprintf(f2,"SPACING 1 1 1\n");
	     fprintf(f2,"ORIGIN 0 0 0\n");
	     fprintf(f2,"POINT_DATA %d\n",nx*ny*nz);
#ifdef SGL
	     fprintf(f2,"VECTORS vectors float\n");
#else
	     fprintf(f2,"VECTORS vectors double\n");
#endif
