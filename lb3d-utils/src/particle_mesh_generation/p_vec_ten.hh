// Filename: p_vec_ten.hh
// This header contains structures for physical vectors and tensors of rank 2
// Physical vectors have type 'p_vec'.
// Physical tensors have type 'p_ten2'.
...
struct p_ten2 {
  ...
  // << operator
    ...
    os  << ten.xx << " " << ten.xy << " " << ten.xz << " "
        << ten.yx << " " << ten.yy << " " << ten.yz << " "
        << ten.zx << " " << ten.zy << " " << ten.zz << endl;
